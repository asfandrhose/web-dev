...
function Persistence.SaveData(player, mainData, pcData, gamemode)
	...
	local gamemodeSuffixes = {
		randomizer = '_Random',
		nuzlocke = '_Nuzlocke',
		['random nuzlocke'] = '_RandomNuzlocke',
		['shiny madness'] = '_ShinyMadness',
		hardcore = '_Hardcore',
		spawner = '_Spawner',
		['random evolution'] = '_RandomEvolution'
	}

	if gamemodeSuffixes[gamemode] then
		id = id .. gamemodeSuffixes[gamemode]
	end
